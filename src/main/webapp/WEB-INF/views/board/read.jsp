	...
	$(document).ready(function(e) {
		...
		function showList(page) {
			replyService.getList(
				{bno : bnoValue, page : page || 1}, function(dto, list) {
					console.log("dto: " + dto);
		...
		function showReplyPage(dto) {
			...
			for (var i = dto.start; i <= dto.end; i++) {
				str += "<li class='page-item'><a class='page-link' data-page='" + i + "' href='" + i + "'>"
						+ i + "</a></li>";
			}
		...
		//댓글 해당 페이지 색 변환
		$(".pagination li a[data-page=" + targetPage + "]").css("color", "darkorange");
